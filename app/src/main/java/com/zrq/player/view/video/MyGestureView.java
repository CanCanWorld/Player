 ...
 * 手势控制
 */
public class MyGestureView extends FrameLayout implements IGestureComponent {

    private static final String TAG = "MyGestureView";

    public MyGestureView(@NonNull Context context) {
        super(context);
    }

    public MyGestureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MyGestureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
